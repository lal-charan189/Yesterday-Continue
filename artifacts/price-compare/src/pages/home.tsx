    ...
    <Layout>
      <div className="flex-1 flex flex-col relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-accent text-sm font-semibold mb-8 backdrop-blur-md">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-extrabold text-white tracking-tight mb-6">
              Find the <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-primary animate-gradient">best price</span>,<br/>in seconds.
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-sm">
              <span className="text-muted/70 font-medium mr-2">Trending:</span>
              {trendingSearches.map((term, i) => (
                <a 
                  key={i}
                  href={`/search?q=${encodeURIComponent(term)}`}
                  className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 hover:bg-white/10 hover:text-white hover:border-white/20 transition-all duration-200 cursor-pointer"
                >
                  {term}
                </a>
              ))}
        ...
        {/* Features Section */}
        <div className="relative z-10 bg-black/40 backdrop-blur-lg border-t border-white/5 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-primary/20 text-primary flex items-center justify-center mb-4 border border-primary/30">
